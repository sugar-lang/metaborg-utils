...
public class FilteringIOAgent extends IOAgent {
  ...
  private final Writer outWriter = new FilteringWriter(new org.sugarj.common.util.PrintStreamWriter(Log.out));
  private final Writer errWriter = new FilteringWriter(new org.sugarj.common.util.PrintStreamWriter(Log.err));
